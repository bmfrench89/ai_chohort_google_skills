...
Screenshots of completed labs / checkpoints — the graded evidence for Module 9.

## Naming convention

`<lab#>-<lab-slug>-<shot>.png` — lab number groups the shots, the suffix says what it shows.
**Just save a shot with any name (or paste it and tell me it's saved); I rename it to the
convention.**
