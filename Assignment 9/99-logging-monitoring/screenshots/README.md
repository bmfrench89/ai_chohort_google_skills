...
`screenshots/<NN-lab-slug>/<shot>.png` — the **subfolder is the lab**, the **filename is the
shot**. Save a shot with any name and tell me; I drop it in the right lab folder and rename it.
